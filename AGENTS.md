...
Static website with an interactive compound interest calculator.
...
- **Chart.js** (~60KB) - Recommended for ease of use
...
- Year-by-year breakdown table (optional)
- Visual chart showing growth over time (optional)
...
- Reasonable ranges (e.g., principal: 1-1,000,000, rate: 0.01-100%, time: 1-50 years)
...
**Visual Feedback:**
- Loading states (if using charts)
...
- `chart.js` - Chart visualisation (optional)
